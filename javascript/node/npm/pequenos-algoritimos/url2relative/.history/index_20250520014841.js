...
const url2="https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/items/XPHB/Maul.webp";

console.log("url1=",url1,"=",urlToLocal(url1));
console.log("url2",url2,"=",urlToLocal(url2));
console.log(url1.indexOf("/img/"));   